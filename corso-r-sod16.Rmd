...
benzinai <- read.csv('benzinai.csv', stringsAsFactors = F)
benzinai$Latitudine<- as.numeric(benzinai$Latitudine)
benzinai$Longitudine<- as.numeric(benzinai$Longitudine)
benzinai <- benzinai[,c(1:10)]
benzinai$Latitudine<- as.numeric(benzinai$Latitudine)
benzinai$Longitudine<- as.numeric(benzinai$Longitudine)
benzinai<- benzinai[complete.cases(benzinai),]
#trasformo il csv
coordinates(benzinai) <- ~Longitudine+Latitudine
plot(meteo.stations, pch=20, col='steelblue')
