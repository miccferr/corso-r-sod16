...
# correct data
staz_meteo@data$elev <- as.numeric(as.character(staz_meteo@data$elev))
staz_meteo@data$elev[1] <- 1370
# visual check
plot(staz_meteo)
```
...
# interpolate! 
idw <- idw(formula = as.numeric(elev) ~ 1, locations = staz_meteo, newdata = grd)  # apply idw model for the data
